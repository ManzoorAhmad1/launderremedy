// app/about/page.tsx - UPDATED with black/purple/white dark theme
"use client";
...
const AboutPage = () => {
  ...
  const values = [
    { icon: Shield, title: "Quality", description: "Never compromise on quality" },
    { icon: Leaf, title: "Eco-friendly", description: "Sustainable cleaning solutions" },
    { icon: Sparkles, title: "Innovation", description: "Constantly improving our process" },
    { icon: Users, title: "Community", description: "Supporting local businesses" },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="aspect-square rounded-2xl overflow-hidden shadow-primary-lg border border-neutral-200 dark:border-neutral-700">
                <div className="w-full h-full bg-gradient-to-br from-primary-500 to-secondary-600 flex items-center justify-center">
                  <div className="text-center p-8">
                    ...
                    <div className="text-3xl md:text-4xl font-light text-white opacity-90">
                      LAUNDRY MADE EASY
                    </div>
              ...
              <motion.div
                ...
                className="absolute -top-4 -right-4 w-20 h-20 bg-white dark:bg-neutral-800 rounded-xl shadow-lg flex items-center justify-center border border-neutral-200 dark:border-neutral-700"
              >
              ...
              <motion.div
                ...
                className="absolute -bottom-4 -left-4 w-16 h-16 bg-white dark:bg-neutral-800 rounded-xl shadow-lg flex items-center justify-center border border-neutral-200 dark:border-neutral-700"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              ...
              >
                <div className="absolute inset-0 bg-gradient-purple opacity-0 hover:opacity-5 transition-opacity rounded-2xl"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="aspect-video rounded-2xl overflow-hidden shadow-primary-lg border border-neutral-200 dark:border-neutral-700">
                <div className="w-full h-full bg-gradient-to-br from-accent-blue/20 to-accent-green/20 dark:from-accent-blue/30 dark:to-accent-green/30 flex items-center justify-center p-8">
