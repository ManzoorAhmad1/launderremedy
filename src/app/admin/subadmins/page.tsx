...
import { Plus, Edit, Trash2, Power, Search, Shield, Key } from "lucide-react";
    ...
    <div className="space-y-6">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {subAdmin.permissions?.length > 0 ? (
                          subAdmin.permissions.slice(0, 3).map((perm: string, i: number) => (
                            <span
                              key={i}
                              className="inline-flex px-2 py-1 text-xs font-semibold rounded-full bg-primary-100 dark:bg-primary-900 text-primary-700 dark:text-primary-300"
                            >
                              {perm}
                            </span>
                          ))
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white dark:bg-neutral-900 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-border">
            <div className="p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder={editingSubAdmin ? "Enter new password to change" : ""}
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {AVAILABLE_PERMISSIONS.map((perm) => (
                      <label
                        key={perm.value}
                        className="flex items-center gap-2 p-3 rounded-lg border border-border cursor-pointer hover:bg-muted transition-colors"
                      >
                        <input
                          type="checkbox"
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
          <div className="bg-white dark:bg-neutral-900 rounded-lg shadow-xl max-w-md w-full p-6 border border-border">
            ...
            <p className="text-foreground mb-6">
              Are you sure you want to delete this sub-admin? All their data will be permanently removed.
            </p>
